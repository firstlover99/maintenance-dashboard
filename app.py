...
st.markdown('<div class="sub-title">호원오토 평택공장 | 보전관리 2팀 | 정한식책임</div>', unsafe_allow_html=True)
...
""")
        ...
        _t_items = [
            ...
            ('TAB 15 — POP양식 변환', [
                ('목적', '광주공장 POP 시스템 14컬럼 원본 파일을 차체팀 표준 21컬럼 형식으로 변환'),
                ('사용 방법', '① 파일 업로드 → ② 원본 미리보기 확인 → ③ 변환 통계 확인 → ④ 변환 미리보기 확인 → ⑤ Excel 다운로드'),
                ('주의', '변환된 파일을 TAB 1에서 업로드하면 로봇/지그 21컬럼 포맷으로 인식됨'),
            ]),
        ]
    ...
    with _m6:
        ...
        _faqs = [
            ...
            ('Q6.  차종 필터가 빈값만 표시됩니다. (광주 원본 사용 시)',
             ...
             '차종 분석이 필요하면 **POP양식 변환 탭(TAB 15)**에서 변환 후 재업로드하세요.'),
